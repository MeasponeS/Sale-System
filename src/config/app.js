...
//正式环境变量,注意修改
const proApiUrl = 'https://testsale.hulian120.com'; //正式 https://pay.hulian120.com
...
export default {
    ...
    wxUrl:'https://wxauth.hulian120.com/open/getTestCodeFor',    // redirect_uri //正式 getPayCodeFor
    shareUrl:'https://hsj.hulian120.com/test/', //正式 https://hsj.hulian120.com/pay/
    requestRetry:4,
    serverUrl:'https://testsale.hulian120.com/sale/api/wx/login', // 正式 https://pay.hulian120.com/sale/api/wx/login 
