    ...
    <div id="app">
        <div class="wxapi_container">
            ...
            <div class="lbox_close wxapi_form">
                ...
                <button class="btn btn_primary" id="onMenuShareTimeline"  @click="shareFriend">onMenuShareTimeline</button>
                ...
                <button class="btn btn_primary" id="openLocation" @click="openLocation">openLocation</button>
                <span class="desc">获取地理位置接口</span>
                <button class="btn btn_primary" id="getLocation" @click="getLocation">getLocation</button>

                <h3 id="menu-webview">界面操作接口</h3>
                <span class="desc">隐藏右上角菜单接口</span>
                <button class="btn btn_primary" id="hideOptionMenu" @click="hideOptionMenu">hideOptionMenu</button>
                <span class="desc">显示右上角菜单接口</span>
                <button class="btn btn_primary" id="showOptionMenu" @click="showOptionMenu">showOptionMenu</button>
                ...
                <button class="btn btn_primary" id="scanQRCode0" @click="scanQRCode0">scanQRCode(微信处理结果)</button>
                <button class="btn btn_primary" id="scanQRCode1" @click="scanQRCode1">scanQRCode(直接返回结果)</button>
                ...
                <button class="btn btn_primary" id="chooseWXPay" @click="pay">chooseWXPay</button>
            </div>
        </div>
    </div>
</template>
